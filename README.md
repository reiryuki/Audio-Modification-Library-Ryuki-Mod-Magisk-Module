...
- I will not add built-in support for soundfx that are not yet registered in AudioModificationLibrary.sh in this module. So if your soundfx module is not yet registered in AudioModificationLibrary.sh, then you must add aml.sh file to your module instead so that your soundfx module can work with this module.
- To uninstall, PLEASE REMOVE VIA MAGISK/KERNELSU/APATCH/KITSUNE MASK APP ONLY

## Changelog

v1.4_RM
- Add Viper AIDL built-in support
